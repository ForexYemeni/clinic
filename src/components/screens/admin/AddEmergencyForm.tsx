...
export function AddEmergencyForm() {
  ...
  return (
    <div className="p-4 pb-24">
      <button onClick={() => setScreen('admin-emergencies')} className="flex items-center gap-2 mb-4 px-3 py-2 bg-white dark:bg-gray-800 rounded-xl border border-border shadow-sm active:scale-[0.97] transition-all">
